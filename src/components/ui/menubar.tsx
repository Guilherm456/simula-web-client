...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center rounded-sm px-3 py-1.5 text-sm font-medium outline-none focus:text-accent-foreground focus:ring-2 focus:ring-ring focus:ring-offset-2 data-[state=open]:text-accent-foreground",
      className,
    )}
    {...props}
  />
